...
\begin{description}
 ...
 %   % It could be possible to use regular expressions to control a lot of the  % merge process.  We could eliminate a number of comparisons that contain  % equivalent functionality in this manner. %  % Regular expressions however could be to cumbersome to use to represent a 
 %@nonl
 %@<<Regular expressions>>
