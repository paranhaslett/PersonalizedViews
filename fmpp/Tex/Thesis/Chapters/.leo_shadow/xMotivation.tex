...
\begin{description}
 ...
 %   % It could be possible to use regular expressions to control a lot of the  % merge process.  We could eliminate a number of comparisons that contain 
 %@nonl
 %@<<Regular expressions>>
