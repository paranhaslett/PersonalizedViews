...
Restricting any valid moves to a container ensures we get moves that don't change the behavior of the program.
...
This means that although there have been changes the bahaviour of the code still has not changed.
%@nonl
%@-node:paran.20140823073953.2207:<<detecting equ>>
%@nl
...
This detection of comments and whitespace also extends to move operations 
