...
% establish if there are superficial changes in curently working projects.  By 
% superficial we mean that the change does not add much of value apart from 
% personal taste or formating.  In some cases cahnges to the order of methods 
...
% because certain comments could be important to others and others irrelivant. 
% We will attempt to establish if there are any patterns in comments to 
% determine if they are superfical or not.  Determining if there are 
% superficial change may indicate that there is a seperation between personal 
